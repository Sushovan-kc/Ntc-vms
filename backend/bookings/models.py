...
class Booking(models.Model):
    ...
    class BookingStatus(models.TextChoices): # Capitalized 'Choice' to follow PEP 8 standards
    ...
    # FIXES applied below: Fixed duplicate variable, accurate lookup path, updated related name
